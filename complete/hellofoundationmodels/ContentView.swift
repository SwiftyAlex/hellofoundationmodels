...
struct ContentView: View {
    var body: some View {
        NavigationStack {
            List {
                Section(content: {
                    NavigationLink(destination: LocationChecker(), label: {
                        Text("Location Checker")
                    })
                    NavigationLink(destination: LandmarkReccomendationView(), label: {
                        Text("Landmark Reccomendations")
                    })
                    NavigationLink(destination: LandmarkReccomendationPlusView(), label: {
                        Text("MapKit Landmark Reccomendations")
                    })
                }, header: {
                    HStack {
                        Image("cb_paris")
